...
@section('title', trans('pages/dashboard/users.users_create'))

@section('mobile_users', 'menu--active')
@section('mobile_users_create', 'menu--active')
@section('mobile_users_sub', 'menu__sub-open')
@section('side_users', 'side-menu--active')
@section('side_users_create', 'side-menu--active')
...
@section('breadcrumb')
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        ...
        <a href="#" class="breadcrumb--active">{{ trans('pages/dashboard/users.users_create') }}</a>
    </div>
@endsection
                        ...
                        <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                            ...
                            <div class="intro-y col-span-12">
                                ...
                                <label
                                    ...
                                    <span>{{ trans('pages/general.select_a_file') }}</span>
